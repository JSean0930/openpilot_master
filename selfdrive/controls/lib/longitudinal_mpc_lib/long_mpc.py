...
def get_stopped_equivalence_factor(v_lead, v_ego):
  ...
  v_diff_offset = 0
  v_diff_offset_max = 0.5 #12,5
  speed_to_reach_max_v_diff_offset = 2.22 #26,12 # in kp/h
  speed_to_reach_max_v_diff_offset = speed_to_reach_max_v_diff_offset
